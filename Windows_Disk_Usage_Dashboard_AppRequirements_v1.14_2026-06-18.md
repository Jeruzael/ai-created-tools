...
- Status: Revised
- Revision notes: Added read-only Standard Review collectors for startup registry entries, startup folders, browser policies, proxy/DNS settings, and Microsoft Defender exclusions.
