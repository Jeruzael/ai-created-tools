...
- Status: Revised
- Revision notes: Added the Security Check tab shell with safety acknowledgement, explicit registry-backup opt-in, placeholder review panels, and disabled future report actions.
